    ...
    chapters: [
        {
            id: '1',
            alignment: 'right',
            title: 'Votre amitié, Madame, est essentielle à mon bonheur [...]',
            image: '',
            imageCredit:'',
            description: '<center><span class="image main"><img src="laperouse/laperouse.jpg" alt=""  style="width:340px;height:389px;" /></span></center><left><p>[...] je le croyais à Albi, et j\'osais, dans mes châteaux en Espagne, passer tous les ans deux mois chez vous avec ma femme. Je me flattais de vous recevoir chez moi ; mon amour-propre allait jusqu à l\'espoir de vous rendre le séjour d\'une aussi petite ville supportable. </p>',
            location: {
                center: [2.18458, 47.61036],
                zoom: 2,
                pitch: 0,
                bearing: 0.00
            },
            onChapterEnter: [
                {
                    layer: 'voyages-points-dk0up2',
                    opacity: 0.8
                },
                {
                    layer: 'voyages-points-56biaa ',
                    opacity: 0.6
                },
                {
                    layer: 'voyages-traces-230906-405t5u',
                    opacity: 0.6
                }
            ]
        ...
        },
        {
            id: '2',
            alignment: 'left',
            title: 'Combien ma situation est différente aujourd\'hui ! Je pars pour faire le tour du monde.',
            image: '',
            imageCredit:'iMMAP',
